...
if($result) {
    echo "<h3> MAKING SENTENCES GAME TABLE </h3>";
       echo "<table  border='10px solid black' style='width:100%'>";
          echo "<tr> <th> game3ID </th><th> question </th><th> textbox </th> <th> sentencefrag </th> </tr>";
    //  echo "<tr>";
	while($row = mysqli_fetch_assoc($result)) {
		...
		echo "<td> " . $row["game3ID"] . " </td> " . " <td> " . $row["question"]. "  </td> " ."  <td> "  . $row["textbox"]." </td> ". "  <td>  ". $row["sentencefrag"]." </td> ".
        " <td>  "."</td>";
        echo "</tr>";
	}
     echo "</tr>";
