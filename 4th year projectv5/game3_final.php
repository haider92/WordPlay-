                ...
                <div class="side-body">
                    ...
                    <script>
                        ...
                        $(document).on("ready", function() {
                           ...
                           // get scores and win data from game3
                            getScoreAndWinData();
                            if(oldscore   <= (score - 1)) {
                                timer=0;
                           ...
                           // if you beat the game3 before timer runs out hide it
                            if(timer == 0) {
                                $("#showtimer").hide();
                    ...
                    // update new highest score
                        updateHighScore = function(score,timer) {
                            $.ajax({
                                type: "POST",
                                url: "insertScoreGame3newhighscore.php",
                                data: {
                                    var1: score,
                                    var2: timer
                                }
                    ...
                    <div><a href="game3.php" class="center-block " id="replay">Replay making sentences</a></div>
