                ...
                <div class="side-body">
                    ...
                    <script>
                        ...
                        $(document).on("ready", function() {
                           ...
                           // get scores and win data from game2
                            getScoreAndWinData();
                            if(oldscore   <= (score - 1)) {
                                timer=0;
                           ...
                           // if you beat the game2 before timer runs out hide it
                            if(timer == 0) {
                                $("#showtimer").hide();
                    ...
                    <div><a href="game2.php" class="center-block " id="replay">Replay spelling words</a></div>
