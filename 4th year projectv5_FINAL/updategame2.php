...
<h2 align="center">Update Question in the spelling words game</h2>  
...
$worked = "";
$game2ID = $question = $dropbox1 = $dropbox2 = $dropbox3 = $dropbox4 = $drag1 = $drag2 = $drag3 = $drag4 = $answer  = "";
$game2IDerr = $questionerr = $dropbox1err = $dropbox2err = $dropbox3err = $dropbox4err = $drag1err   = $drag2err  = $drag3err  = $drag4err = $answererr  = $missingerr = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") 
{
    ...
    else 
   {
    ...
    if ($game2ID !="" && $question != "" && $dropbox1 !="" && $dropbox2 !="" && $dropbox3 !="" && $dropbox4 !="" && $answer !="" &&  $drag1 !="" && $drag2 !="" && $drag3 !="" && $drag4 !="" )
   // attempt UPDATE query execution
   {
           $sql = "UPDATE game2 SET game2ID='$game2ID', question='$question', dropbox1='$dropbox1',dropbox2='$dropbox2', dropbox3='$dropbox3', dropbox4='$dropbox4',drag1='$drag1',drag2='$drag2', drag3='$drag3', drag4='$drag4', answer='$answer'  WHERE game2ID='$game2ID';";
...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"  enctype="multipart/form-data" >
    <p>
        <label for="game2ID"> What row do you want updated in the spelling game:</label>
        <input type="text" name="game2ID" id="game2ID">
         <span class="error">* <?php echo $game2IDerr ?></span>
    </p>
    <p>
        <label for="question">Input a Question that will updated in the database for the spelling game:</label>
    ...
    <p>
        ...
        <span class="error">* <?php echo $dropbox1err ?></span>
    </p>
    <p>
        ...
        <span class="error">* <?php echo $dropbox2err ?></span>
    </p>
    <p>
        ...
        <span class="error">* <?php echo $dropbox3err ?></span>
    </p>
 <p>
        ...
        <span class="error">* <?php echo $dropbox4err ?></span>
    </p>
     <p>
        ...
        <span class="error">* <?php echo $drag1err ?></span>
    </p>
    <p>
        ...
        <span class="error">* <?php echo $drag2err ?></span>
    </p>
    <p>
        ...
        <span class="error">* <?php echo $drag3err ?></span>
    </p>
 <p>
        ...
        <span class="error">* <?php echo $drag4err ?></span>
    </p>
    <p>
        <label for="answer"> put the word that will be updated in full for example fish or wolf:  </label>
